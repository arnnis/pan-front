...
import { stringify, keccak256, getContract as getContract$1, encodePacked, zeroAddress } from 'viem';
...
var GAUGES_CALC_ADDRESS = {
  [ChainId.BSC]: "0x4fF7C80Df31e5864776314D89220Ae18626a6D67",
...
export { GAUGES_ADDRESS, GAUGES_CALC_ADDRESS, GAUGES_SUPPORTED_CHAIN_IDS, GAUGE_TYPE_NAMES, GaugeType, calcGaugesVotingABI, gaugesVotingABI, getAllGauges, getGaugesByChain, safeGetGaugesByChain };
