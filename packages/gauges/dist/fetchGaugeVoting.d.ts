...
export declare const fetchAllGaugesVoting: (client: {
    account: undefined;
    batch?: {
...
}, gaugeInfos: GaugeInfoConfig[], inCap?: boolean | undefined, options?: {
    blockNumber?: bigint;
} | undefined) => Promise<Promise<Gauge[]>>;
//# sourceMappingURL=fetchGaugeVoting.d.ts.map