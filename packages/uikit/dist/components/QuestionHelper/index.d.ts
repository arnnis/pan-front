...
export declare const DottedHelpText: import("styled-components").IStyledComponent<"web", {
...
export declare const QuestionHelperV2: React.FC<React.PropsWithChildren<Props>>;
export {};
