export declare const DropDownHeader: import("styled-components").IStyledComponent<"web", {
...
export declare const DropDownContainer: import("styled-components").IStyledComponent<"web", {
    [x: string]: any;
    [x: number]: any;
    [x: symbol]: any;
