...
export declare const createV4ClOnChainQuoteProvider: ({ onChainProvider, gasLimit, multicallConfigs: multicallConfigsOverride, onAdjustQuoteForGas, }: ProviderConfig) => QuoteProvider;
export declare const createMixedRouteOnChainQuoteProviderV2: ({ onChainProvider, gasLimit, multicallConfigs: multicallConfigsOverride, onAdjustQuoteForGas, }: ProviderConfig) => QuoteProvider;
export declare const createV4BinOnChainQuoteProvider: ({ onChainProvider, gasLimit, multicallConfigs: multicallConfigsOverride, onAdjustQuoteForGas, }: ProviderConfig) => QuoteProvider;
export {};
