import { __export, wrappedCurrency, BASES_TO_CHECK_TRADES_AGAINST, ADDITIONAL_BASES, CUSTOM_BASES, BETTER_TRADE_LESS_HOPS_THRESHOLD, pancakePairABI, wrappedCurrencyAmount, stableSwapPairABI, STABLE_SWAP_INFO_ADDRESS } from './chunk-U7ACFW2G.mjs';
import flatMap from 'lodash/flatMap.js';
import { ERC20Token, Price, Percent, CurrencyAmount, TradeType, isTradeBetter, Pair, Trade, ZERO, Fraction, ONE, computePriceImpact } from '@pancakeswap/sdk';
