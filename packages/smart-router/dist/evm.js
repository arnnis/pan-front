...
var chunkMWQ5Y6WM_js = require('./chunk-MWQ5Y6WM.js');
...
var v4Sdk = require('@pancakeswap/v4-sdk');
...
var feeOnTransferDetectorAddresses = {
  [chains.ChainId.ETHEREUM]: "0xe9200516a475b9e6FD4D1c452858097F345A6760",
  [chains.ChainId.SEPOLIA]: "0xD8b14F915b1b4b1c4EE4bF8321Bea018E72E5cf3",
  [chains.ChainId.BSC]: "0x003BD52f589F23346E03fA431209C29cD599d693",
  [chains.ChainId.BSC_TESTNET]: "0xE83BD854c1fBf54424b4d914163BF855aB1131Aa",
  [chains.ChainId.ARBITRUM_ONE]: "0xD8b14F915b1b4b1c4EE4bF8321Bea018E72E5cf3",
  [chains.ChainId.ARBITRUM_SEPOLIA]: "0xD8b14F915b1b4b1c4EE4bF8321Bea018E72E5cf3",
  [chains.ChainId.POLYGON_ZKEVM]: "0xe9200516a475b9e6FD4D1c452858097F345A6760",
  [chains.ChainId.POLYGON_ZKEVM_TESTNET]: "0xbc60A0d9536B6F75b1FfE18b47364ED684EA0260",
  [chains.ChainId.BASE]: "0xD8b14F915b1b4b1c4EE4bF8321Bea018E72E5cf3",
  [chains.ChainId.BASE_SEPOLIA]: "0xD8b14F915b1b4b1c4EE4bF8321Bea018E72E5cf3",
  [chains.ChainId.ZKSYNC]: "0xED87D01674199355CEfC05648d17E037306d7962",
  [chains.ChainId.ZKSYNC_TESTNET]: "0x869505373d830104130F95c1E7d578dE7E58C0a8",
  [chains.ChainId.LINEA]: "0xD8b14F915b1b4b1c4EE4bF8321Bea018E72E5cf3",
  [chains.ChainId.LINEA_TESTNET]: "0x3412378f17B1b44E8bcFD157EcE1a4f59DA5A77a"
};
...
async function fetchTokenFeeOnTransfer(publicClient, tokenAddress) {
  ...
  const baseToken = sdk.WNATIVE[publicClient.chain.id];
  if (!contract) {
...
chunkMWQ5Y6WM_js.__export(smartRouter_exports, {
  ...
  isV2Pool: () => isV2Pool,
  isV3Pool: () => isV3Pool,
  isV4BinPool: () => isV4BinPool,
  isV4ClPool: () => isV4ClPool,
  log: () => log,
  logger: () => logger,
...
var PoolType = /* @__PURE__ */ ((PoolType2) => {
  ...
  PoolType2[PoolType2["V4CL"] = 3] = "V4CL";
  PoolType2[PoolType2["V4BIN"] = 4] = "V4BIN";
  return PoolType2;
})(PoolType || {});
...
var RouteType = /* @__PURE__ */ ((RouteType2) => {
  ...
  RouteType2[RouteType2["V4CL"] = 5] = "V4CL";
  RouteType2[RouteType2["V4BIN"] = 6] = "V4BIN";
  return RouteType2;
})(RouteType || {});

// evm/v3-router/types/v4MixedQuoter.ts
var V4MixedQuoterActions = /* @__PURE__ */ ((V4MixedQuoterActions2) => {
  V4MixedQuoterActions2[V4MixedQuoterActions2["SS_2_EXACT_INPUT_SINGLE"] = 0] = "SS_2_EXACT_INPUT_SINGLE";
  V4MixedQuoterActions2[V4MixedQuoterActions2["SS_3_EXACT_INPUT_SINGLE"] = 1] = "SS_3_EXACT_INPUT_SINGLE";
  V4MixedQuoterActions2[V4MixedQuoterActions2["V2_EXACT_INPUT_SINGLE"] = 2] = "V2_EXACT_INPUT_SINGLE";
  V4MixedQuoterActions2[V4MixedQuoterActions2["V3_EXACT_INPUT_SINGLE"] = 3] = "V3_EXACT_INPUT_SINGLE";
  V4MixedQuoterActions2[V4MixedQuoterActions2["V4_CL_EXACT_INPUT_SINGLE"] = 4] = "V4_CL_EXACT_INPUT_SINGLE";
  V4MixedQuoterActions2[V4MixedQuoterActions2["V4_BIN_EXACT_INPUT_SINGLE"] = 5] = "V4_BIN_EXACT_INPUT_SINGLE";
  return V4MixedQuoterActions2;
...
function isV4BinPool(pool) {
  return pool.type === 4 /* V4BIN */;
}
function isV4ClPool(pool) {
  return pool.type === 3 /* V4CL */;
}
...
var getPoolAddress = memoize__default.default(
  ...
  (pool) => {
    ...
    const [token0, token1] = isV2Pool(pool) ? [pool.reserve0.currency.wrapped, pool.reserve1.currency.wrapped] : isV3Pool(pool) ? [pool.token0.wrapped, pool.token1.wrapped] : [pool.currency0, pool.currency1];
...
function getTokenPrice(pool, base, quote) {
  ...
  if (isV4ClPool(pool)) {
    ...
    const v3Pool = new v3Sdk.Pool(currency0.wrapped, currency1.wrapped, fee, sqrtRatioX96, liquidity, tick);
    const tokenPrice = v3Pool.priceOf(base.wrapped);
    const [baseCurrency, quoteCurrency] = base.wrapped.equals(currency0.wrapped) ? [currency0, currency1] : [currency1, currency0];
    return new sdk.Price(baseCurrency, quoteCurrency, tokenPrice.denominator, tokenPrice.numerator);
  }
  if (isV4BinPool(pool)) {
    const { activeId, binStep, currency0, currency1 } = pool;
    const rawPrice = v4Sdk.getPriceFromId(BigInt(activeId), BigInt(binStep));
    const price = new sdk.Price(
      currency0,
      currency1,
      rawPrice * 10n ** BigInt(currency0.decimals),
      v4Sdk.SCALE * 10n ** BigInt(currency1.decimals)
    );
...
function encodeMixedRouteToPath(route, exactOutput) {
  ...
  const { path, types } = route.pools.reduce(
    ({ inputToken, path: path2, types: types2 }, pool, index) => {
      ...
      const fee = isV3Pool(pool) ? pool.fee : chunkMWQ5Y6WM_js.V2_FEE_PATH_PLACEHOLDER;
      if (index === 0) {
        return {
...
function getRouteTypeByPools(pools) {
  ...
  invariant6__default.default(routeType !== void 0, "INVALID_ROUTE_TYPE");
  return routeType;
}
...
function wrapPrice(price) {
  return new sdk.Price(price.baseCurrency.wrapped, price.quoteCurrency.wrapped, price.denominator, price.numerator);
}
function getMidPrice({ path, pools }) {
  ...
  return new sdk.Price(currencyIn, currencyOut, price.denominator, price.numerator);
}

// evm/v3-router/utils/getPriceImpact.ts
function getPriceImpact(trade) {
  let spotOutputAmount = sdk.CurrencyAmount.fromRawAmount(trade.outputAmount.currency, 0);
  for (const route of trade.routes) {
    const { inputAmount } = route;
    const midPrice = getMidPrice(route);
    spotOutputAmount = spotOutputAmount.add(
      sdk.CurrencyAmount.fromRawAmount(trade.outputAmount.currency, midPrice.wrapped.quote(inputAmount.wrapped).quotient)
    );
  }
  if (spotOutputAmount.equalTo(0)) {
    return sdk.ONE_HUNDRED_PERCENT;
  }
...
function getUsdGasToken(chainId) {
  return chunkMWQ5Y6WM_js.usdGasTokensByChain[chainId]?.[0] ?? null;
}
...
var _ApproveAndCall = class {
  ...
  static encodeCallPositionManager(calldatas) {
    invariant6__default.default(calldatas.length > 0, "NULL_CALLDATA");
...
var _SwapRouter = class {
  ...
  static encodeV2Swap(trade, options, routerMustCustody, performAggregatedSlippageCheck) {
    ...
    const recipient = routerMustCustody ? chunkMWQ5Y6WM_js.ADDRESS_THIS : typeof options.recipient === "undefined" ? chunkMWQ5Y6WM_js.MSG_SENDER : sdk.validateAndParseAddress(options.recipient);
    if (trade.tradeType === sdk.TradeType.EXACT_INPUT) {
    ...
    for (const route of trade.routes) {
      ...
      if (singleHop) {
        ...
        for (let i = 0; i < sections.length; i++) {
          ...
          const recipientAddress = lastSectionInRoute ? recipient : chunkMWQ5Y6WM_js.ADDRESS_THIS;
  ...
  static encodeSwaps(anyTrade, options, isSwapAndAdd) {
    ...
    if (options.inputTokenPermit) {
      invariant6__default.default(sampleTrade.inputAmount.currency.isToken, "NON_TOKEN_PERMIT");
  ...
  static swapCallParameters(trades, options) {
    ...
    return {
      ...
      value: v3Sdk.toHex(inputIsNative ? totalAmountIn.quotient : ZERO2)
    };
  }
  /**
   * Produces the on-chain method name to call and the hex encoded parameters to pass as arguments for a given trade.
  ...
  static swapAndAddCallParameters(trades, options, position, addLiquidityOptions, tokenInApprovalType, tokenOutApprovalType) {
    ...
    if (options.outputTokenPermit) {
      invariant6__default.default(quoteAmountOut.currency.isToken, "NON_TOKEN_PERMIT_OUTPUT");
...
chunkMWQ5Y6WM_js.__export(transformer_exports, {
...
var getToken = memoize__default.default(
  (chainId, address) => {
    if (!chainId || !address) {
      return void 0;
    }
    const tokens$1 = tokens.getTokensByChain(chainId);
...
function isTokenInCommonBases(token) {
  return Boolean(token && chunkMWQ5Y6WM_js.BASES_TO_CHECK_TRADES_AGAINST[token.chainId]?.find((t) => t.equals(token)));
}
function createTokenBasesFromGaugesGetter() {
  const getCurrencyIdentifier = (c) => `${c?.chainId}_${c?.wrapped.address}_${c?.isNative}`;
  const cache = {};
  return async function getTokenBasesFromGauges2(currency) {
    ...
    const gauges$1 = await gauges.safeGetGaugesByChain(chainId);
    ...
    for (const gauge of gauges$1) {
      const { type } = gauge;
      if (type === gauges.GaugeType.V2 || type === gauges.GaugeType.V3) {
      ...
      if (type === gauges.GaugeType.StableSwap) {
...
var getTokenBasesFromGauges = createTokenBasesFromGaugesGetter();
...
async function getAdditionalCheckAgainstBaseTokens(currencyA, currencyB) {
  ...
  const additionalBases = {
    ...chainId ? chunkMWQ5Y6WM_js.ADDITIONAL_BASES[chainId] ?? {} : {}
  };
  const uniq = (tokens) => uniqBy__default.default(tokens, (t) => t.address);
  const additionalA = currencyA && chainId ? uniq([...additionalBases[currencyA.wrapped.address] || [], ...await getTokenBasesFromGauges(currencyA)]) ?? [] : [];
  const additionalB = currencyB && chainId ? uniq([...additionalBases[currencyB.wrapped.address] || [], ...await getTokenBasesFromGauges(currencyB)]) ?? [] : [];
  return [...additionalA, ...additionalB];
}
var getCheckAgainstBaseTokens = memoize__default.default(
  async (currencyA, currencyB) => {
    const chainId = currencyA?.chainId;
    if (!chainId || !currencyA || !currencyB || !isCurrenciesSameChain(currencyA, currencyB)) {
      return [];
    }
    const [tokenA, tokenB] = chainId ? [chunkMWQ5Y6WM_js.wrappedCurrency(currencyA, chainId), chunkMWQ5Y6WM_js.wrappedCurrency(currencyB, chainId)] : [void 0, void 0];
    if (!tokenA || !tokenB) {
      return [];
    }
    const common = chunkMWQ5Y6WM_js.BASES_TO_CHECK_TRADES_AGAINST[chainId] ?? [];
    return [...common, ...await getAdditionalCheckAgainstBaseTokens(currencyA, currencyB)];
  },
  resolver
);
var getPairCombinations = memoize__default.default(
  async (currencyA, currencyB) => {
    const chainId = currencyA?.chainId;
    if (!chainId || !currencyA || !currencyB || !isCurrenciesSameChain(currencyA, currencyB)) {
      return [];
    ...
    return [
      ...
      if (!chainId)
        return true;
      const customBases = chunkMWQ5Y6WM_js.CUSTOM_BASES[chainId];
...
function getBestSwapRouteBy(tradeType, percentToQuotes, percents, chainId, by, { maxSplits = 4, minSplits = 0 }) {
  ...
  if (!chunkMWQ5Y6WM_js.usdGasTokensByChain[chainId] || !chunkMWQ5Y6WM_js.usdGasTokensByChain[chainId][0]) {
    throw new Error(`Could not find a USD token for computing gas costs on ${chainId}`);
  }
  const usdToken = chunkMWQ5Y6WM_js.usdGasTokensByChain[chainId][0];
...
async function createGasModel({
  ...
  const estimateGasCost2 = ({ pools }, { initializedTickCrossedList }) => {
    ...
    for (const pool of pools) {
      ...
      if (isV2Pool(pool)) {
        if (!poolTypeSet.has(type)) {
          baseGasUse += chunkMWQ5Y6WM_js.BASE_SWAP_COST_V2;
          poolTypeSet.add(type);
          continue;
        }
        baseGasUse += chunkMWQ5Y6WM_js.COST_PER_EXTRA_HOP_V2;
        continue;
      }
      if (isV3Pool(pool)) {
        if (!poolTypeSet.has(type)) {
          baseGasUse += chunkMWQ5Y6WM_js.BASE_SWAP_COST_V3(chainId);
          poolTypeSet.add(type);
        }
        baseGasUse += chunkMWQ5Y6WM_js.COST_PER_HOP_V3(chainId);
        continue;
      }
      if (isStablePool(pool)) {
        if (!poolTypeSet.has(type)) {
          baseGasUse += chunkMWQ5Y6WM_js.BASE_SWAP_COST_STABLE_SWAP;
          poolTypeSet.add(type);
          continue;
        }
        baseGasUse += chunkMWQ5Y6WM_js.COST_PER_EXTRA_HOP_STABLE_SWAP;
        continue;
      }
    }
    const tickGasUse = chunkMWQ5Y6WM_js.COST_PER_INIT_TICK(chainId) * totalInitializedTicksCrossed;
    const uninitializedTickGasUse = chunkMWQ5Y6WM_js.COST_PER_UNINIT_TICK * 0n;
    ...
    return {
      ...
      gasCostInToken: isQuoteNative && quoteCurrency.isNative ? sdk.CurrencyAmount.fromRawAmount(sdk.Native.onChain(chainId), gasCostInToken.quotient) : gasCostInToken,
      gasCostInUSD
    };
  };
  return {
...
var getV2PoolsOnChain = createOnChainPoolFactory({
  abi: chunkMWQ5Y6WM_js.pancakePairABI,
...
var getStablePoolsOnChain = createOnChainPoolFactory({
  abi: chunkMWQ5Y6WM_js.stableSwapPairABI,
  getPossiblePoolMetas: async ([currencyA, currencyB]) => {
    const poolConfigs = await stableSwapSdk.getStableSwapPools(currencyA.chainId);
...
var getV3PoolsWithoutTicksOnChain = createOnChainPoolFactory({
  ...
  buildPool: ({ currencyA, currencyB, fee, id: address }, [liquidity, slot0, balanceA, balanceB]) => {
    ...
    return {
      ...
      token0,
      token1,
      reserve0: sdk.CurrencyAmount.fromRawAmount(token0, balance0),
      reserve1: sdk.CurrencyAmount.fromRawAmount(token1, balance1),
      fee,
...
function poolSelectorFactory({
  ...
  return function tvlSelector(currencyA, currencyB, unorderedPoolsWithTvl) {
    ...
    const baseTokens = chunkMWQ5Y6WM_js.BASES_TO_CHECK_TRADES_AGAINST[chainId] ?? [];
...
var getV3PoolMeta = memoize__default.default(
  ([currencyA, currencyB, feeAmount]) => ({
    id: v3Sdk.Pool.getAddress(currencyA.wrapped, currencyB.wrapped, feeAmount),
    currencyA,
    currencyB,
    fee: feeAmount
  }),
...
function subgraphAllPoolsQueryFactory({
  ...
  return async function getAllPools({
    ...
    while (hasMorePools) {
      ...
      lastId = getPoolId3(poolsAtCurrentPage[poolsAtCurrentPage.length - 1]);
      pools = [...pools, ...poolsAtCurrentPage];
    }
    return pools;
  };
...
var V4_CL_QUOTER_ADDRESSES = {
  [chains.ChainId.BSC_TESTNET]: "0xD2a534e28efb7e44Da94ae942F892E71F7462142"
};
var V4_BIN_QUOTER_ADDRESSES = {
  [chains.ChainId.BSC_TESTNET]: "0x740469475C0e268F2110444BB8Bc3114E5321B90"
};
var V4_MIXED_ROUTE_QUOTER_ADDRESSES = {
  [chains.ChainId.BSC_TESTNET]: "0x5B5209dBFD9dB69Fcc14f6591fD23089c229E143"
};
var V4_SUPPORTED_CHAINS = [chains.ChainId.BSC_TESTNET];
    ...
    return async function getRoutesWithQuotes(routes, { gasModel }) {
      ...
      for (const route of routes) {
        try {
          ...
          const finalQuote = sdk.CurrencyAmount.fromRawAmount(quoteCurrency, quote.quotient);
...
// evm/abis/IV4MixedRouteQuoter.ts
var v4MixedRouteQuoterAbi = [
  {
    inputs: [
      { internalType: "address", name: "_factoryV3", type: "address" },
      { internalType: "address", name: "_factoryV2", type: "address" },
...
function encodeV4MixedRouteActions(route) {
  return viem.bytesToHex(
    new Uint8Array(
      route.pools.map((p) => {
        ...
        if (isV4ClPool(p)) {
          return 4 /* V4_CL_EXACT_INPUT_SINGLE */;
        }
        if (isV4BinPool(p)) {
          return 5 /* V4_BIN_EXACT_INPUT_SINGLE */;
        }
...
function encodeV4MixedRouteParams(route) {
  return route.pools.map((p) => {
    if (isV2Pool(p) || isStablePool(p)) {
      return "0x";
    }
    if (isV3Pool(p)) {
      return viem.encodeAbiParameters(viem.parseAbiParameters("uint24"), [p.fee]);
    }
    if (isV4ClPool(p)) {
      const poolKey = {
        currency0: swapSdkCore.getCurrencyAddress(p.currency0),
        currency1: swapSdkCore.getCurrencyAddress(p.currency1),
        fee: p.fee,
        hooks: p.hooks,
      ...
      return viem.encodeAbiParameters(v4RouteParamsAbi, [
        {
          poolKey: v4Sdk.encodePoolKey(poolKey),
          hookData: "0x"
        }
      ]);
    }
...
function encodeV4RouteToPath(route, exactOutput) {
  ...
  const { path } = pools.reduce(
    ({ baseCurrency, path: path2 }, pool) => {
      ...
      if (!isV4Cl && !isV4Bin)
        throw new Error(`Invalid v4 pool ${pool}`);
      const quoteCurrency = getOutputCurrency(pool, baseCurrency);
      const parameters = v4Sdk.encodePoolParameters(
        isV4Cl ? {
      ...
      return {
        ...
        path: [
          ...path2,
          {
            intermediateCurrency: swapSdkCore.getCurrencyAddress(quoteCurrency),
            fee: pool.fee,
            hooks: pool.hooks ?? viem.zeroAddress,
...
var SUCCESS_RATE_CONFIG = {
  ...
  [chains.ChainId.SEPOLIA]: 0.1,
  [chains.ChainId.ARBITRUM_SEPOLIA]: 0.1,
  [chains.ChainId.BASE_SEPOLIA]: 0.1,
  [chains.ChainId.MONAD_TESTNET]: 0.1
};
  ...
  return function createOnChainQuoteProvider({
    ...
    const createGetRoutesWithQuotes = (isExactIn = true) => {
      ...
      return async function getRoutesWithQuote(routes, { blockNumber: blockNumberFromConfig, gasModel, retry: retryOptions, signal }) {
        ...
        const multicallConfigs = multicallConfigsOverride?.[chainId] || chunkMWQ5Y6WM_js.BATCH_MULTICALL_CONFIGS[chainId] || chunkMWQ5Y6WM_js.BATCH_MULTICALL_CONFIGS[chains.ChainId.ETHEREUM];
        const {
...
function processQuoteResults(quoteResults, routes, gasModel, adjustQuoteForGas) {
  ...
  for (let i = 0; i < quoteResults.length; i += 1) {
    ...
    const quote = swapSdkCore.CurrencyAmount.fromRawAmount(quoteCurrency, quoteRaw.toString());
...
var createMixedRouteOnChainQuoteProvider = onChainQuoteProviderFactory({
  getQuoterAddress: (chainId) => chunkMWQ5Y6WM_js.MIXED_ROUTE_QUOTER_ADDRESSES[chainId],
...
var createV3OnChainQuoteProvider = onChainQuoteProviderFactory({
  getQuoterAddress: (chainId) => chunkMWQ5Y6WM_js.V3_QUOTER_ADDRESSES[chainId],
...
var createV4ClOnChainQuoteProvider = onChainQuoteProviderFactory({
  getQuoterAddress: (chainId) => V4_CL_QUOTER_ADDRESSES[chainId],
  getQuoteFunctionName: (isExactIn) => isExactIn ? "quoteExactInput" : "quoteExactOutput",
  abi: clQuoterAbi,
  getCallInputs: (route, isExactIn) => [
    {
      exactCurrency: swapSdkCore.getCurrencyAddress(isExactIn ? route.input : route.output),
...
var createMixedRouteOnChainQuoteProviderV2 = onChainQuoteProviderFactory({
  getQuoterAddress: (chainId) => V4_MIXED_ROUTE_QUOTER_ADDRESSES[chainId],
  getQuoteFunctionName: () => "quoteMixedExactInput",
  abi: v4MixedRouteQuoterAbi,
  getCallInputs: (route) => [
    route.path.map((p) => swapSdkCore.getCurrencyAddress(p)),
    encodeV4MixedRouteActions(route),
    encodeV4MixedRouteParams(route),
    `0x${route.amount.quotient.toString(16)}`
  ]
});
var createV4BinOnChainQuoteProvider = onChainQuoteProviderFactory({
  getQuoterAddress: (chainId) => V4_BIN_QUOTER_ADDRESSES[chainId],
  getQuoteFunctionName: (isExactIn) => isExactIn ? "quoteExactInput" : "quoteExactOutput",
  abi: binQuoterAbi,
  getCallInputs: (route, isExactIn) => [
    {
...
function createQuoteProvider(config) {
  ...
  const createGetRouteWithQuotes = (isExactIn = true) => {
    ...
    const getV4ClQuotes = isExactIn ? v4ClOnChainQuoteProvider.getRouteWithQuotesExactIn : v4ClOnChainQuoteProvider.getRouteWithQuotesExactOut;
    const getV4BinQuotes = isExactIn ? v4BinOnChainQuoteProvider.getRouteWithQuotesExactIn : v4BinOnChainQuoteProvider.getRouteWithQuotesExactOut;
    const createMixedRouteQuoteFetcher = (chainId) => {
      const mixedRouteOnChainQuoteProvider = V4_SUPPORTED_CHAINS.includes(chainId) ? mixedRouteOnChainQuoteProviderV2 : mixedRouteOnChainQuoteProviderV1;
    ...
    return async function getRoutesWithQuotes(routes, { blockNumber, gasModel, signal }) {
      ...
      for (const route of routes) {
        ...
        if (route.type === 5 /* V4CL */) {
          v4ClRoutes.push(route);
          continue;
        }
        if (route.type === 6 /* V4BIN */) {
...
var schema_exports = {};
chunkMWQ5Y6WM_js.__export(schema_exports, {
  zPools: () => zPools,
...
var zHex = zod.z.custom((val) => /^0x[a-fA-F0-9]*$/.test(val));
...
var zStablePool = zod.z.object({
  type: zod.z.literal(2 /* STABLE */),
  balances: zod.z.array(zCurrencyAmount),
  amplifier: zBigNumber,
  fee: zod.z.string(),
  address: zAddress
}).required();
var zV4ClPool = zod.z.object({
  type: zod.z.literal(3 /* V4CL */),
  currency0: zCurrency,
  currency1: zCurrency,
  fee: zFee,
  liquidity: zBigNumber,
  sqrtRatioX96: zBigNumber,
  tick: zod.z.number(),
  tickSpacing: zod.z.number(),
  poolManager: zAddress,
  id: zHex
}).required().extend({
  hooks: zAddress.optional()
});
var zV4BinPool = zod.z.object({
  type: zod.z.literal(4 /* V4BIN */),
  currency0: zCurrency,
  currency1: zCurrency,
  fee: zFee,
  activeId: zod.z.number(),
  binStep: zod.z.number(),
  poolManager: zAddress,
  id: zHex
}).required().extend({
  hooks: zAddress.optional()
});
var zPools = zod.z.array(zod.z.union([zV2Pool, zV3Pool, zStablePool, zV4ClPool, zV4BinPool]));
...
chunkMWQ5Y6WM_js.__export(v4_router_exports, {
  ...
  getV4BinCandidatePools: () => getV4BinCandidatePools,
  getV4BinPoolsWithoutBins: () => getV4BinPoolsWithoutBins,
  getV4ClCandidatePools: () => getV4ClCandidatePools,
  getV4ClPoolsWithoutTicks: () => getV4ClPoolsWithoutTicks,
  log: () => log2,
  logger: () => logger2,
  metric: () => metric2
});
...
var BIN_HOOKS = [viem.zeroAddress];
...
function createBitmapIndexListBuilder(tickRange) {
  return function buildBitmapIndexList2({ currentTick, fee, ...rest }) {
    const tickSpacing = v3Sdk.TICK_SPACINGS[fee];
...
async function fillPoolsWithTicks({ pools, clientProvider, gasLimit }) {
  ...
  const tickLensAddress = chunkMWQ5Y6WM_js.V3_TICK_LENS_ADDRESSES[chainId];
  ...
  const bitmapIndexes = pools.map(({ tick, fee }, i) => buildBitmapIndexList({ currentTick: tick, fee, poolIndex: i })).reduce((acc, cur) => {
    acc.push(...cur);
    return acc;
  }, []);
  const res = await multicall.multicallByGasLimit(
  ...
  for (const [index, result] of res.results.entries()) {
    ...
    const data = result.success ? viem.decodeFunctionResult({
      abi: tickLensAbi,
      functionName: "getPopulatedTicksInWord",
      data: result.result
    }) : void 0;
    const newTicks = data?.map(
      ({ tick, liquidityNet, liquidityGross }) => new v3Sdk.Tick({
        index: tick,
        liquidityNet,
        liquidityGross
      })
...
async function getV4ClCandidatePools({
  currencyA,
  currencyB,
  clientProvider,
  gasLimit
  ...
  const native = sdk.Native.onChain(currencyA?.chainId);
...
var getV4ClPoolsWithoutTicks = createOnChainPoolFactory({
  abi: v4Sdk.CLPoolManager,
  getPossiblePoolMetas: async ([currencyA, currencyB]) => {
    ...
    for (const { fee, tickSpacing } of CL_PRESETS) {
      for (const hooks of CL_HOOKS) {
        const poolKey = {
          currency0: swapSdkCore.getCurrencyAddress(currency0),
          currency1: swapSdkCore.getCurrencyAddress(currency1),
          fee,
          parameters: {
            tickSpacing
          },
          // TODO: use constant from v4 sdk
          poolManager: "0x26Ca53c8C5CE90E22aA1FadDA68AB9a08f7BA06f",
          hooks
        };
        const id = v4Sdk.getPoolId(poolKey);
        metas.push({
          currencyA,
          currencyB,
          fee,
...
async function getV4BinCandidatePools({
  currencyA,
  currencyB,
  clientProvider,
  gasLimit
...
var getV4BinPoolsWithoutBins = createOnChainPoolFactory({
  abi: v4Sdk.BinPoolManager,
  getPossiblePoolMetas: async ([currencyA, currencyB]) => {
    const [currency0, currency1] = swapSdkCore.sortCurrencies([currencyA, currencyB]);
    const metas = [];
    for (const { fee, binStep } of BIN_PRESETS) {
      for (const hooks of BIN_HOOKS) {
        const poolKey = {
          ...
          // TODO: use constant from v4 sdk
          poolManager: "0x1DF0be383e9d17DA4448E57712849aBE5b3Fa33b",
          hooks
        };
        const id = v4Sdk.getPoolId(poolKey);
        metas.push({
...
function createPriceCalculator({ graph, quote, gasPriceWei }) {
  ...
  priceMap.set(quote, new sdk.Price(quote.currency, quote.currency, 1, 1));
  ...
  while (nextEdges.length) {
    ...
    invariant6__default.default(vFromQuotePrice !== void 0, "Invalid quote price");
    priceMap.set(vTo, p.multiply(vFromQuotePrice));
    nextEdges = getNextEdges(vTo);
    processedVert.add(vTo);
  }
  const native = sdk.Native.onChain(chainId).wrapped;
  ...
  const gasPriceInQuote = nativePriceInQuote?.quote(sdk.CurrencyAmount.fromRawAmount(native, gasPriceWei));
  if (!gasPriceInQuote) {
  ...
  function getNextEdges(v) {
    ...
    const newEdges = v.edges.filter((e) => {
      ...
      invariant6__default.default(tokenReserve !== void 0, "Unexpected empty token reserve");
...
function estimateGasCost({ pool, poolAfter }) {
  if (isV2Pool(pool)) {
    return chunkMWQ5Y6WM_js.BASE_SWAP_COST_V2;
  }
  if (isV3Pool(pool) && isV3Pool(poolAfter)) {
    const { ticks, token0, tick } = pool;
    invariant6__default.default(ticks !== void 0, "[Estimate gas]: No valid tick list found");
    const { tick: tickAfter } = poolAfter;
    const { chainId } = token0;
    const numOfTicksCrossed = v3Sdk.TickList.countInitializedTicksCrossed(ticks, tick, tickAfter);
    const tickGasUse = chunkMWQ5Y6WM_js.COST_PER_INIT_TICK(chainId) * BigInt(numOfTicksCrossed);
    return chunkMWQ5Y6WM_js.BASE_SWAP_COST_V3(chainId) + chunkMWQ5Y6WM_js.COST_PER_HOP_V3(chainId) + tickGasUse;
  }
  if (isStablePool(pool)) {
    return chunkMWQ5Y6WM_js.BASE_SWAP_COST_STABLE_SWAP;
  }
...
function getBetterTrade(tradeA, tradeB) {
  ...
  if (tradeA && !tradeB)
    return tradeA;
  const isExactIn = tradeA.tradeType === sdk.TradeType.EXACT_INPUT;
  if (isExactIn) {
...
function createGraph({ pools, graph }) {
  ...
  return {
    ...
    applySwap: async ({ isExactIn, route }) => {
      ...
      invariant6__default.default(amount !== void 0, "[Apply swap]: Invalid base amount");
      let quote = amount;
      let gasCost = 0n;
      for (const i of loopPools()) {
        ...
        invariant6__default.default(edge !== void 0, "[Apply swap]: No valid edge found");
        const quoteResult = await getPoolQuote(edge.pool, quote);
        invariant6__default.default(quoteResult !== void 0, "[Apply swap]: Failed to get quote");
...
function getStreamedAmounts(amount, streams) {
  ...
  const streamDistributions = Array.isArray(streams) ? streams.map((stream) => new sdk.Fraction(stream, streamSum)) : Array.from({ length: streams }).map(() => new sdk.Fraction(1, streamSum));
  const numOfStreams = streamDistributions.length;
  let sum2 = new sdk.Fraction(0);
  const amounts = [];
  for (const [index, stream] of streamDistributions.entries()) {
    ...
    const revisedStream = index === numOfStreams - 1 ? new sdk.Fraction(1).subtract(sum2) : stream;
...
var getGasCostInCurrency = ({
  ...
  return sdk.CurrencyAmount.fromRawAmount(currency, gasCostInCurrencyRaw?.quotient || 0);
};
...
async function getBestTrade2({
  ...
  const buildTrade = (g, routes2) => {
    const {
      ...
      {
        gasUseEstimate: 0n,
        quoteAmount: sdk.CurrencyAmount.fromRawAmount(quoteCurrency, 0),
        gasUseEstimateBase: sdk.CurrencyAmount.fromRawAmount(baseCurrency, 0),
        gasUseEstimateQuote: sdk.CurrencyAmount.fromRawAmount(quoteCurrency, 0),
        inputAmountWithGasAdjusted: sdk.CurrencyAmount.fromRawAmount(inputCurrency, 0),
        outputAmountWithGasAdjusted: sdk.CurrencyAmount.fromRawAmount(outputCurrency, 0)
      }
    );
    return {
      gasUseEstimate,
  ...
  async function findBestRoute(amount) {
    invariant6__default.default(start !== void 0 && finish !== void 0, "Invalid start/finish vertice");
    ...
    const getBestRoute = (vert) => {
      ...
      for (let v = finish; getBestSource(v); v = getNeighbour(getBestSource(v), v)) {
        ...
        invariant6__default.default(bestSource !== void 0, "Invalid best source");
      ...
      invariant6__default.default(quoteAmountRaw !== void 0, "Invalid quote amount");
      const quoteAmount = sdk.CurrencyAmount.fromRawAmount(quoteCurrency, quoteAmountRaw.quotient);
      ...
      const quoteAmountWithGasAdjusted = sdk.CurrencyAmount.fromRawAmount(
        quoteCurrency,
    ...
    for (; ; ) {
      ...
      for (const e of vert.edges) {
        ...
        try {
          ...
          invariant6__default.default(bestAmount !== void 0, "Invalid amount");
          const quoteResult = await getPoolQuote(e.pool, bestAmount);
          invariant6__default.default(quoteResult !== void 0, "Invalid quote result");
          const { quote } = quoteResult;
          const gasPriceInV2 = priceCalculator.getGasPriceInBase(v2);
          invariant6__default.default(gasPriceInV2 !== void 0, "Invalid gas price in v2");
  ...
  invariant6__default.default(s !== void 0, "[Graph rebuild]: Invalid start vertice");
  ...
  for (const r of routes) {
    ...
    const quote = sdk.CurrencyAmount.fromRawAmount(quoteCurrency, quoteRaw.quotient);
...
function getBestStreamsConfig(trade) {
  ...
  const amount = trade.tradeType === sdk.TradeType.EXACT_INPUT ? inputAmount : outputAmount;
...
var schema_exports2 = {};
chunkMWQ5Y6WM_js.__export(schema_exports2, {
  zPools: () => zPools2,
  zRouterPostParams: () => zRouterPostParams2
});
var zChainId2 = zod.z.nativeEnum(chains.ChainId);
var zFee2 = zod.z.nativeEnum(v3Sdk.FeeAmount);
var zTradeType2 = zod.z.nativeEnum(sdk.TradeType);
var zAddress2 = zod.z.custom((val) => /^0x[a-fA-F0-9]{40}$/.test(val));
var zBigNumber2 = zod.z.string().regex(/^[0-9]+$/);
var zSignedBigInt = zod.z.string().regex(/^-?[0-9]+$/);
var zHex2 = zod.z.custom((val) => /^0x[a-fA-F0-9]*$/.test(val));
var zCurrency2 = zod.z.object({
  address: zAddress2,
  decimals: zod.z.number(),
  symbol: zod.z.string()
}).required();
var zTick = zod.z.object({
  index: zod.z.number(),
  liquidityGross: zSignedBigInt,
  liquidityNet: zSignedBigInt
}).required();
var zCurrencyAmountBase = zod.z.object({
...
var zV2Pool2 = zod.z.object({
  type: zod.z.literal(0 /* V2 */),
  reserve0: zCurrencyAmount2,
  reserve1: zCurrencyAmount2
}).required();
var zV3Pool2 = zod.z.object({
  type: zod.z.literal(1 /* V3 */),
  token0: zCurrency2,
  token1: zCurrency2,
  fee: zFee2,
  ...
  ticks: zod.z.array(zTick).optional()
}).required({
  type: true,
  token0: true,
  token1: true,
...
var zStablePool2 = zod.z.object({
  type: zod.z.literal(2 /* STABLE */),
  balances: zod.z.array(zCurrencyAmount2),
  amplifier: zBigNumber2,
  fee: zod.z.string(),
  address: zAddress2
}).required();
var zV4ClPool2 = zod.z.object({
  type: zod.z.literal(3 /* V4CL */),
...
var zPools2 = zod.z.array(zod.z.union([zV3Pool2, zV2Pool2, zStablePool2, zV4ClPool2, zV4BinPool2]));
var zRouterPostParams2 = zod.z.object({
  chainId: zChainId2,
...
chunkMWQ5Y6WM_js.__export(transformer_exports2, {
...
var log_2 = debug__default.default(SCOPE_PREFIX2);
var metric2 = log_2.extend(SCOPE2.metric);
var log2 = log_2.extend(SCOPE2.log);
var logger2 = {
  metric: metric2,
  log: log2,
  error: debug__default.default(SCOPE_PREFIX2).extend(SCOPE2.error),
  enable: (namespace) => {
    let namespaces = namespace;
    if (namespace.includes(",")) {
...
Object.defineProperty(exports, 'ADDITIONAL_BASES', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.ADDITIONAL_BASES; }
});
Object.defineProperty(exports, 'ADDRESS_THIS', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.ADDRESS_THIS; }
});
Object.defineProperty(exports, 'BASES_TO_CHECK_TRADES_AGAINST', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.BASES_TO_CHECK_TRADES_AGAINST; }
});
Object.defineProperty(exports, 'BASE_SWAP_COST_STABLE_SWAP', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.BASE_SWAP_COST_STABLE_SWAP; }
});
Object.defineProperty(exports, 'BASE_SWAP_COST_V2', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.BASE_SWAP_COST_V2; }
});
Object.defineProperty(exports, 'BASE_SWAP_COST_V3', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.BASE_SWAP_COST_V3; }
});
Object.defineProperty(exports, 'BATCH_MULTICALL_CONFIGS', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.BATCH_MULTICALL_CONFIGS; }
});
Object.defineProperty(exports, 'BETTER_TRADE_LESS_HOPS_THRESHOLD', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.BETTER_TRADE_LESS_HOPS_THRESHOLD; }
});
Object.defineProperty(exports, 'BIG_INT_TEN', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.BIG_INT_TEN; }
});
Object.defineProperty(exports, 'BIPS_BASE', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.BIPS_BASE; }
});
Object.defineProperty(exports, 'COST_PER_EXTRA_HOP_STABLE_SWAP', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.COST_PER_EXTRA_HOP_STABLE_SWAP; }
});
Object.defineProperty(exports, 'COST_PER_EXTRA_HOP_V2', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.COST_PER_EXTRA_HOP_V2; }
});
Object.defineProperty(exports, 'COST_PER_HOP_V3', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.COST_PER_HOP_V3; }
});
Object.defineProperty(exports, 'COST_PER_INIT_TICK', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.COST_PER_INIT_TICK; }
});
Object.defineProperty(exports, 'COST_PER_UNINIT_TICK', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.COST_PER_UNINIT_TICK; }
});
Object.defineProperty(exports, 'CUSTOM_BASES', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.CUSTOM_BASES; }
});
Object.defineProperty(exports, 'MIN_BNB', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.MIN_BNB; }
});
Object.defineProperty(exports, 'MIXED_ROUTE_QUOTER_ADDRESSES', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.MIXED_ROUTE_QUOTER_ADDRESSES; }
});
Object.defineProperty(exports, 'MSG_SENDER', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.MSG_SENDER; }
});
Object.defineProperty(exports, 'SMART_ROUTER_ADDRESSES', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.SMART_ROUTER_ADDRESSES; }
});
Object.defineProperty(exports, 'STABLE_SWAP_INFO_ADDRESS', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.STABLE_SWAP_INFO_ADDRESS; }
});
Object.defineProperty(exports, 'V2_FEE_PATH_PLACEHOLDER', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.V2_FEE_PATH_PLACEHOLDER; }
});
Object.defineProperty(exports, 'V2_ROUTER_ADDRESS', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.V2_ROUTER_ADDRESS; }
});
Object.defineProperty(exports, 'V3_QUOTER_ADDRESSES', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.V3_QUOTER_ADDRESSES; }
});
Object.defineProperty(exports, 'V3_TICK_LENS_ADDRESSES', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.V3_TICK_LENS_ADDRESSES; }
});
Object.defineProperty(exports, 'usdGasTokensByChain', {
  enumerable: true,
  get: function () { return chunkMWQ5Y6WM_js.usdGasTokensByChain; }
});
...
exports.V4MixedQuoterActions = V4MixedQuoterActions;
exports.V4Router = v4_router_exports;
exports.feeOnTransferDetectorAddresses = feeOnTransferDetectorAddresses;
exports.fetchTokenFeeOnTransfer = fetchTokenFeeOnTransfer;
exports.fetchTokenFeeOnTransferBatch = fetchTokenFeeOnTransferBatch;
exports.getPoolAddress = getPoolAddress;
exports.getRouteTypeByPools = getRouteTypeByPools;
