...
var MULTICALL_ADDRESS = {
  ...
  [chains.ChainId.MONAD_TESTNET]: "0xF490DB8D37520bb41d45B79a1c5749A1FdA9f4Ea"
};
...
var BLOCK_CONFLICT_TOLERANCE = {
  ...
  [chains.ChainId.MONAD_TESTNET]: 3
};
...
var DEFAULT_GAS_LIMIT_BY_CHAIN = {
  ...
  [chains.ChainId.OPBNB]: 100000000n,
  [chains.ChainId.OPBNB_TESTNET]: 100000000n
};
...
function getMulticallContract({ chainId, client }) {
  ...
  return viem.getContract({ abi: iMulticallABI, address, client });
}
