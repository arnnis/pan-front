...
export type XOrder<input extends Currency = Currency, output extends Currency = Currency, tradeType extends TradeType = TradeType> = {
    type: OrderType.DUTCH_LIMIT;
...
export type PriceOrder<input extends Currency = Currency, output extends Currency = Currency, tradeType extends TradeType = TradeType> = ClassicOrder<tradeType> | XOrder<input, output, tradeType>;
